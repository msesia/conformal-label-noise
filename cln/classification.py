...
class LabelNoiseConformal:
    def __init__(self, X, Y, black_box, K, alpha, n_cal=0.5, M=None, V_ci=None, V_alpha=None, Zeta_upp=None, V_max=None,
                 rho_tilde=None, label_conditional=True, calibration_conditional=False, gamma=None,
...
class LabelNoiseConformal_bounded_RR:
    def __init__(self, X, Y, black_box, K, alpha, n_cal=0.5, epsilon_ci=None, epsilon_alpha=None, epsilon_max=None,
        ...
        if self.label_conditional:
            ...
            # Construct the I-hat set
            if self.optimistic:
                I_hat_values = np.arange(1,n_cal+1)/n_cal - (1.0-alpha) + np.maximum(-(1.0-alpha)/n_cal, Delta_hat - delta)
            else:
                I_hat_values = np.arange(1,n_cal+1)/n_cal - (1.0-alpha) + Delta_hat - delta
            I_hat = np.where(I_hat_values>=0)[0]
