...
make_figure_1(plot.alpha=0.1, plot.guarantee="marginal", plot.K=4, save_plots=TRUE, reload=TRUE)
make_figure_1(plot.alpha=0.1, plot.guarantee="lab-cond", plot.K=4, save_plots=TRUE, reload=TRUE)
...
make_figure_6("block-const", plot.alpha=0.1, plot.guarantee="lab-cond", plot.K=4, save_plots=TRUE, reload=TRUE)
make_figure_6("random-const", plot.alpha=0.1, plot.guarantee="lab-cond", plot.K=4, save_plots=TRUE, reload=TRUE)
make_figure_6("random-enrich", plot.alpha=0.1, plot.guarantee="lab-cond", plot.K=4, save_plots=TRUE, reload=TRUE)
...
summary <- load_data(7)
make_figure_7("uniform-const", plot.alpha=0.1, plot.guarantee="lab-cond", plot.K=4, save_plots=TRUE, reload=FALSE)
make_figure_7("random-enrich", plot.alpha=0.1, plot.guarantee="lab-cond", plot.K=4, save_plots=TRUE, reload=FALSE)
make_figure_7("uniform-const", plot.alpha=0.1, plot.guarantee="marginal", plot.K=4, save_plots=TRUE, reload=FALSE)
make_figure_7("random-enrich", plot.alpha=0.1, plot.guarantee="marginal", plot.K=4, save_plots=TRUE, reload=FALSE)
...
make_figure_estimation_2_ci <- function(plot.K=4, plot.epsilon_max=0.2, plot.epsilon_train="corrupted", plot.alpha=0.1, plot.epsilon_alpha=0.05, plot.guarantee="lab-cond",
    ...
    df <- summary %>%
        ...
        mutate(`Confidence bound` = factor(Key, c("epsilon_low", "epsilon_upp", "epsilon_hat"), c("Lower", "Upper", "Point estimate")))
...
summary <- load_data_estimation(43)
make_figure_estimation_3(plot.K=4, plot.contamination="block-const", plot.alpha=0.1, plot.epsilon_alpha=0.05, plot.guarantee="lab-cond", save_plots=TRUE, reload=FALSE)
make_figure_estimation_3(plot.K=4, plot.contamination="random-const", plot.alpha=0.1, plot.epsilon_alpha=0.05, plot.guarantee="lab-cond", save_plots=TRUE, reload=FALSE)
